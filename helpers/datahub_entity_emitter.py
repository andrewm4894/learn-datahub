...
class DatahubEntityEmitter(DatahubRestEmitter):
    ...
    def update_dataset(
        self, name, platform='bigquery', env='DEV', description=None, url=None, tags=None, change_type='upsert', owners=None, custom_properties=None, 
        ...
        if tags:
            ...
            mcpw = MetadataChangeProposalWrapper(
                ...
                aspect=models.GlobalTagsClass(tags=[models.TagAssociationClass(builder.make_tag_urn(tag)) for tag in tags])
            )
            self.emit_mcp(mcp=mcpw)
    ...
    def update_dashboard(
        self, name, inputs=None, title=None, description=None, change_type='upsert', platform='datastudio', tags=None, owners=None, glossary_terms=None, 
        links=None
        ):
